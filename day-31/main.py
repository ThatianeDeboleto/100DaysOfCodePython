...
try:
    ...
    original_data = pd.read_csv("data/ingles_words.csv")
    print(original_data)
...
def next_card():
    ...
    canvas.itemconfig(card_word, text=current_card["Ingles"], fill="black")
...
cross_image = PhotoImage(file="imagens/wrong.png")
unknown_button = Button(image=cross_image, highlightthickness=0, command=next_card)
unknown_button.grid(row=1, column=0)

check_image = PhotoImage(file="imagens/right.png")
